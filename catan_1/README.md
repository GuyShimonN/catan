...
מצורף תמונה של לוח המשחק עם חלוקת הקודודים משושישים והצלעות
...
במטלה זאת מימשו גרסה פשוטה יותר של המשחק עבור 3 שחקנים.
## חוקי המשחק
...
סדר המשחק יהיה שחקן לפי הסדר 123. בכל תור השחקנים מטילים 2 קוביות. בהתאם לתוצאת ההטלה, השחקנים מקבלים משאבים כמו שפורט מקודם.
...
- הוא יכול לבנות דרכים, יישובים או ערים ויכול לקנות קלפי פיתוח.
  אם סכום ההטלה הוא 7(פרט לשני הסיבובים הראשונים שבהם אין אופציה להטלת 7), על כל השחקנים בעלי יותר מ-7 קלפי משאבים לבחור מחצית מהקלפים ולהחזיר אותם לערימה.
  ### סיום המשחק
...
שינוים ביחס למשחק המקורי ###
- כמובן שהמשחק יהיה עבור 3 שחקנים בלבד.
- כל שחקן מתחיל את המשחק עם 2 יישובים ו-2 קטעי דרך.
- כל שחקן מקבל משאבים התחלתיים בהתאם למקומות שבהם הוא מיקם את היישובים.
- סדר המשחק יהיה שחקן לפי הסדר 123.
- כל שחקן יכול לבצע פעולות כמו סחר, בנייה ורכישת קלפי פיתוח מבלי על הגבלה על כמות או זמן.
- כל שחקן יכול לבנות יישובים וערים על פי המחירים המצויינים.
- כל שחקן יכול לרכוש קלפי פיתוח בהתאם למחירים המצויינים.
- אין שימוש בכלי האביר
- אין אופציה להחלפות מול הקופה
- 