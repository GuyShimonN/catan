...
//#include <iostream>
//
//Player::Player(const char *name) : name(name), victoryPoints(0) {
...
//    if (removeResource(Resource::ORE, 1) && removeResource(Resource::WOOL, 1) && removeResource(Resource::GRAIN, 1)) {
